...
class Suma(
...
) : NodoAritmetico(nodoIzq, nodoDer, "suma") {
    override fun realizarOperacion(
        ...
        val valor1 = expr1.objeto.toString()
        val valor2 = expr2.objeto.toString()
        return Expresion((valor1 + valor2), Tipo.STRING, expr1.linea, expr1.linea)
    }
}